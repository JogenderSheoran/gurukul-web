            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-edit mr-2"></i>Edit Team Member</h3>
                    ...
                    <form action="{{ route('admin.team-member.update', $member->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="member_type" id="teaching" value="teaching" {{ old('member_type', $member->member_type) == 'teaching' ? 'checked' : '' }} required>
                                                <label class="form-check-label" for="teaching">Teaching</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="member_type" id="non_teaching" value="non_teaching" {{ old('member_type', $member->member_type) == 'non_teaching' ? 'checked' : '' }} required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('designation') is-invalid @enderror" id="designation" name="designation" value="{{ old('designation', $member->designation) }}" required>
                                        @error('designation')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6" id="teaching_subject_wrapper" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('teaching_subject') is-invalid @enderror" id="teaching_subject" name="teaching_subject" value="{{ old('teaching_subject', $member->teaching_subject) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if($member->profile_image)
                                            <div class="mt-2">
                                                <img src="{{ asset('storage/' . $member->profile_image) }}" alt="{{ $member->full_name }}" class="img-thumbnail" style="max-height: 100px;">
                                            </div>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Update Team Member</button>
