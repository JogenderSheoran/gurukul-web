        ...
        <div style="text-align:center"> <img src="{{URL::asset('images/card/main_logo.png')}}" height="140" width="140" style="margin-top:10px;"></div><br>
            ...
            <form id="form" method="post" action="#">
                ...
                <div class="row">
                    ...
                    <input type="hidden" value="123" name="user_id" id="userId">
                                                ...
                                                <div class="col-md-4 mb-3 radio-group" id="card{{$key+1}}">
                                                    <div class="card">
                                                        ...
                                                        {{--    @php 
                                                            ...
                                                            <div style="text-align:center;"><button type="button" style="border-radius:10px;" class="btn btn-primary select-btn" id="selectbtn" onclick="getCardId({{$c->id}},{{$c->price}})">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter mobile no" id="mobile_no" name="mobile_no" onkeyup="sendOtp()">
                            </div>
                        </div>
                    </div>
                ...
                {{-- <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="amout" id="amount" class="gst-font"></label>
                                <label for="gst" id="gst" class="gst-font"></label>
                                <label for="total_amount" id="total_amount" class="gst-font"></label>
                            </div>
                        </div>
                        <br>  
                    </div>
...
function getCardId(card,amount){
  $("#card").val(card);
  var gst = amount * 18 /100;
  var total_amount = gst + amount;
  $("#amount").text('Amount :'+ amount.toFixed(2));
  $("#gst").text('Gst (18%) : '+gst.toFixed(2))
