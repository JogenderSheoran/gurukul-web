                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('admin.infrastructure-section.edit', $infrastructureSection->id) }}" class="btn btn-warning btn-sm">
                            ...
                            <div class="col-md-12">
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <td>{{ $sectionNames[$infrastructureSection->section_key] ?? $infrastructureSection->section_key }}</td>
                                    </tr>
                                    <tr>
                                        <th>Section Key</th>
                                        <td><code>{{ $infrastructureSection->section_key }}</code></td>
                                    </tr>
                                    <tr>
                                        <th>Main Image</th>
                                        <td>
                                    ...
                                    <tr>
                                        <th>Created At</th>
                                        <td>{{ $infrastructureSection->created_at->format('M d, Y h:i A') }}</td>
                                    </tr>
                                    <tr>
                                        <th>Updated At</th>
                                        <td>{{ $infrastructureSection->updated_at->format('M d, Y h:i A') }}</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
