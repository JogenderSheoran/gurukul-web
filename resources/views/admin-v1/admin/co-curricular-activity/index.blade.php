...
@section('title', 'Co-curricular Activities Management')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-theater-masks mr-2"></i>Co-curricular Activities Management</h3>
                    </div>
                    <div class="card-body">
                        @if(session('success'))
                        ...
                        @if($activity)
                            ...
                            <div class="tab-content">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    @if($activity->main_image)
                                                        <img src="{{ asset('storage/' . $activity->main_image) }}" alt="Main" class="img-fluid" style="max-height: 300px;">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="edit">
                                    <form action="{{ route('admin.co-curricular-activity.update') }}" method="POST" enctype="multipart/form-data" class="mt-3">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="description" name="description" rows="6" required>{{ old('description', $activity->description) }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    @if($activity->main_image)
                                                        <img src="{{ asset('storage/' . $activity->main_image) }}" alt="Current" class="img-thumbnail mt-2" style="max-height: 150px;">
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                        ...
                                        <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Update Co-curricular Activities</button>
                                    </form>
                                </div>
                            </div>
                        @else
                            <div class="alert alert-info"><i class="fas fa-info-circle"></i> No information found. Please add below.</div>
                            <form action="{{ route('admin.co-curricular-activity.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Save Co-curricular Activities</button>
                            </form>
                        @endif
                    </div>
                </div>
