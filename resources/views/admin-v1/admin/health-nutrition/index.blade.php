...
@section('title', 'Health Nutrition Management')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-heartbeat mr-2"></i>Health Nutrition Management</h3>
                    </div>
                    <div class="card-body">
                        @if(session('success'))
                        ...
                        @if($healthNutrition)
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    @if($healthNutrition->main_image)
                                                        <img src="{{ asset('storage/' . $healthNutrition->main_image) }}" alt="Main" class="img-fluid" style="max-height: 300px;">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-body">{!! $healthNutrition->description !!}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        @if($healthNutrition->gallery_image)
                                                            @foreach($healthNutrition->gallery_image as $image)
                                ...
                                <div class="tab-pane fade" id="edit">
                                    <form action="{{ route('admin.health-nutrition.update') }}" method="POST" enctype="multipart/form-data" class="mt-3">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    @if($healthNutrition->main_image)
                                                        <img src="{{ asset('storage/' . $healthNutrition->main_image) }}" alt="Current" class="img-thumbnail mt-2" style="max-height: 150px;">
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="description" name="description" rows="6" required>{{ old('description', $healthNutrition->description) }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                        ...
                        @else
                            ...
                            <form action="{{ route('admin.health-nutrition.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
