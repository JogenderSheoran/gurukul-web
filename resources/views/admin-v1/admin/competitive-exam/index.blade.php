...
@section('title', 'Competitive Exam Management')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-trophy mr-2"></i>Competitive Exam Management</h3>
                    </div>
                    <div class="card-body">
                        @if(session('success'))
                        ...
                        @if($exam)
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    @if($exam->main_image)
                                                        <img src="{{ asset('storage/' . $exam->main_image) }}" alt="Main" class="img-fluid" style="max-height: 300px;">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-body">{!! $exam->description !!}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        @if($exam->gallery_images)
                                                            @foreach($exam->gallery_images as $image)
                                ...
                                <div class="tab-pane fade" id="edit">
                                    <form action="{{ route('admin.competitive-exam.update') }}" method="POST" enctype="multipart/form-data" class="mt-3">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="description" name="description" rows="6" required>{{ old('description', $exam->description) }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    @if($exam->main_image)
                                                        <img src="{{ asset('storage/' . $exam->main_image) }}" alt="Current" class="img-thumbnail mt-2" style="max-height: 150px;">
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                        ...
                                        <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Update Competitive Exam</button>
                                    </form>
                                </div>
                            </div>
                        @else
                            <div class="alert alert-info"><i class="fas fa-info-circle"></i> No information found. Please add below.</div>
                            <form action="{{ route('admin.competitive-exam.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Save Competitive Exam</button>
                            </form>
                        @endif
                    </div>
                </div>
