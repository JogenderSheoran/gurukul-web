...
@section('title', 'Create Inner Banner')
@section('content')
    <!-- Main Content -->
    <section class="content">
        <div class="container-fluid">
            <!-- Inner Banner Create Form -->
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="createInner BannerForm" method="POST" action="{{ route('admin.inner-banner.store') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="image">Inner Banner Image <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary">
                                                <i class="fas fa-save"></i> Create Inner Banner
                                            </button>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createInner BannerForm').on('submit', function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            Swal.fire({
                                title: 'Success!',
                                text: 'Inner Banner created successfully.',
                                icon: 'success',
                            ...
                            Swal.fire('Error', response.message || 'Failed to create inner-banner', 'error');
                        }
                    },
                    error: function(xhr) {
                        var errors = xhr.responseJSON?.errors;
                        var errorMessage = 'Failed to create inner-banner.';
