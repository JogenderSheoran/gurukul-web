...
@section('title', 'Edit Home Page Text')
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-edit mr-2"></i>Edit Home Page Text</h3>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.home-page-text.update', $homePageText->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="heading_en" name="heading_en" 
                                               value="{{ old('heading_en', $homePageText->heading_en) }}" 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="heading_hi" name="heading_hi" 
                                               value="{{ old('heading_hi', $homePageText->heading_hi) }}" 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="text_en" name="text_en" rows="6" 
                                                  placeholder="Enter text content in English" required>{{ old('text_en', $homePageText->text_en) }}</textarea>
                                        @error('text_en')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="text_hi" name="text_hi" rows="6" 
                                                  placeholder="हिंदी में पाठ सामग्री दर्ज करें" required>{{ old('text_hi', $homePageText->text_hi) }}</textarea>
                                        @error('text_hi')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status" required>
                                            <option value="active" {{ old('status', $homePageText->status) == 'active' ? 'selected' : '' }}>Active</option>
                                            <option value="inactive" {{ old('status', $homePageText->status) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                        @error('status')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> Update Text
                                    </button>
